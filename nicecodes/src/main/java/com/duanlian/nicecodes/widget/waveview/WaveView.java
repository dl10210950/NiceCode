package com.duanlian.nicecodes.widget.waveview;
...
public class WaveView extends SurfaceView {
    ...
    private int mXThreeOffset = 0;

    private Paint mWavePaint, mTwoWavePaint, mThreeWavePaint;
...
//         mTwoWavePaint.setAntiAlias(true);
        ...
        mThreeWavePaint = new Paint();
        // 设置风格为实线
        mThreeWavePaint.setStyle(Paint.Style.FILL);
//        mThreeWavePaint.setAntiAlias(true);
        // 设置画笔颜色
        mThreeWavePaint.setColor(0x55FFFFFF);
        mHolder = getHolder();
        setZOrderOnTop(true);
                ...
                try {
                    if (null != canvas) {
                        ...
                        for (int i = 0; i < mTotalWidth; i++) {
                            ...
                            // 绘制第3条水波纹
                            canvas.drawLine(i, mTotalHeight, i,
                                        mTotalHeight / 2 - mResetThreeYPositions[i],
                                        mThreeWavePaint);
